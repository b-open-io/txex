...
import { parseBCATMetadata, parseBCATChunk, BCAT_PREFIX, BCATPART_PREFIX } from "../src/protocols/bcat";
import { readFile } from "node:fs/promises";

// Known test vectors - txids in display format (big-endian)
const SHUAA_METADATA_TXID = "fb3c1b442b352f6dcf503dcfa8ad274897184487f41928832858122c1e669da1";
